...
surface: ["src/kernel/drift-base.ts", "src/kernel/referee-gate.ts", "src/kernel/referee.ts", "src/cli/verify.ts", "src/fs/layout.ts", "tests/kernel/drift-worktree.test.ts", "detent-prd-v3.md"]
