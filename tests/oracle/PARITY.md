...
| `test_contract.py::test_gate_accepts_runnable_failing_command` | pending-M1 | T-020 (M1) | — |  |
| `test_contract.py::test_gate_executes_and_flags_unrunnable` | pending-M1 | T-020 (M1) | — |  |
...
| `test_gates.py::test_persistent_failure_survives_filter` | pending-M1 | T-022 (M1) | — |  |
| `test_gates.py::test_run_and_flake_filter` | pending-M1 | T-022 (M1) | — |  |
...
| `test_kernel_e2e.py::test_flake_charges_nothing_and_quarantines` | pending-M1 | T-022 (M1) | — |  |
